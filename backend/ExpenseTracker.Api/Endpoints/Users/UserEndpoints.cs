...
using ExpenseTracker.Api.Endpoints.Users.Handlers.DeleteCurrentUser;
using ExpenseTracker.Api.Endpoints.Users.Handlers.DemoteUser;
using ExpenseTracker.Api.Endpoints.Users.Handlers.GetCurrentUser;
using ExpenseTracker.Api.Endpoints.Users.Handlers.GetUserById;
using ExpenseTracker.Api.Endpoints.Users.Handlers.GetUsers;
using ExpenseTracker.Api.Endpoints.Users.Handlers.LockUser;
using ExpenseTracker.Api.Endpoints.Users.Handlers.PromoteUser;
using ExpenseTracker.Api.Endpoints.Users.Handlers.UnlockUser;
using ExpenseTracker.Api.Endpoints.Users.Handlers.UpdateCurrentUser;
using ExpenseTracker.Api.Endpoints.Users.Handlers.UpdateCurrentUserPassword;
using ExpenseTracker.Api.Models;
using ExpenseTracker.Application.Features.Users.Models;
using ExpenseTracker.Application.Models;

namespace ExpenseTracker.Api.Endpoints.Users;
...
internal sealed class UserEndpoints : IEndpointModule
{
    public void MapEndpoints(IEndpointRouteBuilder app)
    {
        ...
        group.MapPost(ApiRoutes.User.MeDelete, DeleteCurrentUserEndpointHandler.Handle)
            .WithName(nameof(DeleteCurrentUserEndpointHandler))
            ...
            .WithDescription(
                ...
                **Notes**:
                - This action is irreversible and will permanently remove the user's data.
                - All active sessions for the user will be revoked immediately after deletion.

                **Possible responses**:
                - `200 OK`: User account successfully deleted.
                - `401 Unauthorized`: No valid session or session expired.
                - `403 Forbidden`: User account is locked or they are not allowed to perform this action.
        ...
        group.MapGet(ApiRoutes.User.List, GetUsersEndpointHandler.Handle)
            .RequireRateLimiting(RateLimitPolicyNames.User.GetUsers)
        ...
        group.MapGet(ApiRoutes.User.Me, GetCurrentUserEndpointHandler.Handle)
            .RequireRateLimiting(RateLimitPolicyNames.User.GetCurrent)
        ...
        group.MapGet(ApiRoutes.User.GetById, GetUserByIdEndpointHandler.Handle)
            .RequireRateLimiting(RateLimitPolicyNames.User.GetById)
        ...
        group.MapPatch(ApiRoutes.User.Me, UpdateCurrentUserEndpointHandler.Handle)
            .RequireRateLimiting(RateLimitPolicyNames.User.UpdateCurrent)
        ...
        group.MapPatch(ApiRoutes.User.MePassword, UpdateCurrentUserPasswordEndpointHandler.Handle)
            .RequireRateLimiting(RateLimitPolicyNames.User.UpdatePassword)
        ...
        group.MapPost(ApiRoutes.User.Promote, PromoteUserEndpointHandler.Handle)
            .RequireRateLimiting(RateLimitPolicyNames.User.Promote)
        ...
        group.MapPost(ApiRoutes.User.Demote, DemoteUserEndpointHandler.Handle)
            .RequireRateLimiting(RateLimitPolicyNames.User.Demote)
        ...
        group.MapPost(ApiRoutes.User.Lock, LockUserEndpointHandler.Handle)
            .RequireRateLimiting(RateLimitPolicyNames.User.Lock)
        ...
        group.MapPost(ApiRoutes.User.Unlock, UnlockUserEndpointHandler.Handle)
            .RequireRateLimiting(RateLimitPolicyNames.User.Unlock)
